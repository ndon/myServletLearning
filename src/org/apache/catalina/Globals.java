...
public final class Globals {
	...
	/**
	 * The servlet context attribute under which we store the class loader used
	 * for loading servlets (as an object of type java.lang.ClassLoader).
	 */
	...
	/**
	 * The request attribute under which we forward the request URI (as an
	 * object of type String) of the page on which an error occurred.
	 */
	public static final String EXCEPTION_PAGE_ATTR = "javax.servlet.error.request_uri";

	/**
	 * The request attribute under which we forward a Java exception type (as an
	 * object of type Class) to an error page.
	 */
	public static final String EXCEPTION_TYPE_ATTR = "javax.servlet.error.exception_type";

	/**
	 * The request attribute under which we forward an HTTP status message (as
	 * an object of type STring) to an error page.
	 */
	public static final String ERROR_MESSAGE_ATTR = "javax.servlet.error.message";

	/**
	 * The request attribute under which the Invoker servlet will store the
	 * invoking servlet path, if it was used to execute a servlet indirectly
	 * instead of through a servlet mapping.
	 */
	public static final String INVOKED_ATTR = "org.apache.catalina.INVOKED";

	/**
	 * The request attribute under which we expose the value of the
	 * <code>&lt;jsp-file&gt;</code> value associated with this servlet, if any.
	 */
	...
	/**
	 * The name of the cookie used to pass the session identifier back and forth
	 * with the client.
	 */
	...
	/**
	 * The request attribute under which we forward an HTTP status code (as an
	 * object of type Integer) to an error page.
	 */
	public static final String STATUS_CODE_ATTR = "javax.servlet.error.status_code";

	/**
	 * The servlet context attribute under which we record the set of welcome
	 * files (as an object of type String[]) for this application.
	 */
	 ...
	 * directory (as an object of type File) for use by servlets within this web
	 * application.
	 */
