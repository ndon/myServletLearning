 ...
 * be used for the Response implementation required by most Connectors. Only the
...
public abstract class ResponseBase implements Response, ServletResponse {
	...
	/**
	 * Set the Context with which this Response is associated. This should be
	 * called as soon as the appropriate Context is identified.
	 *
	 * @param context
	 ...
	 * output stream. Flush the output stream as necessary.
	 *
	 * @param b
	 ...
	 * the specified offset, to our output stream. Flush the output stream as
	 * necessary.
	 *
	 * @param b
