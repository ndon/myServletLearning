...
public class HttpResponseBase extends ResponseBase implements HttpResponse, HttpServletResponse {
	...
	/**
	 * Return an array of all cookies set for this response, or a zero-length
	 * array if no cookies have been set.
	 */
	 ...
	 * only the first is returned; use getHeaderValues() to retrieve all of
	 * them.
	 *
	 * @param name
	...
	/**
	 * Return an array of all the header names set for this response, or a
	 * zero-length array if no headers have been set.
	 */
	...
	/**
	 * Return an array of all the header values associated with the specified
	 * header name, or an zero-length array if there are no such header values.
	 *
	 * @param name
	 *            Header name to look up
	 */
	 ...
	 * (This method must be overridden by subclasses of this as to correctly
	 * return the highest HTTP version number supported as specified in Section
	 * 3.1 of RFC-2616).
	 *
	...
	/**
	 * Clear any content written to the buffer. In addition, all cookies and
	 * headers are cleared, and the status is reset.
	 *
	 * @exception IllegalStateException
	 *                if this response has already been committed
	 */
