...
/**
 * Wrapper around the standard <code>java.io.PrintWriter</code> that keeps track
 * of whether or not any characters have ever been written (even if they are
 * still buffered inside the PrintWriter or any other Writer that it uses above
 * the underlying TCP/IP socket). This is required by the semantics of several
 * calls on ServletResponse, which are required to throw an
...
public class ResponseWriter extends PrintWriter {
	 ...
	 *
	 * @param writer
	 *            OutputStreamWriter to which we are attached
	 * @param stream
	 *            ResponseStream to which we are attached
	 */
